...
CREATE OR REPLACE PACKAGE PKG_ALUNO IS
    PROCEDURE exclui_aluno(id_aluno IN NUMBER);
    PROCEDURE listar_maiores_de_idade;
...
CREATE OR REPLACE PACKAGE BODY PKG_ALUNO IS
    ...
    PROCEDURE exclui_aluno(id_aluno IN NUMBER) IS
    BEGIN
    ...
    PROCEDURE listar_maiores_de_idade IS
...
CREATE OR REPLACE PACKAGE PKG_PROFESSOR IS
    PROCEDURE professor_turma_total;
    FUNCTION total_turma(p_id_professor IN NUMBER) RETURN NUMBER;
...
CREATE OR REPLACE PACKAGE BODY PKG_PROFESSOR IS
    ...
    PROCEDURE professor_turma_total IS
    ...
    END professor_turma_total;
    --Function para total de turmas de um professor:
    FUNCTION total_turma(p_id_professor IN NUMBER) RETURN NUMBER IS
        v_total_turmas NUMBER;
    BEGIN
        SELECT COUNT(*)
        INTO v_total_turmas
